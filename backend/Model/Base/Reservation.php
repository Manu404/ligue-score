...
abstract class Reservation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\ReservationTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Reservation object.
     */
     ...
     * @return $this|\Model\Reservation The current object (for fluent API support)
     */
    ...
    public function setPlayerid($v)
    {
        ...
        if ($this->playerid !== $v) {
            $this->playerid = $v;
            $this->modifiedColumns[ReservationTableMap::COL_PLAYERID] = true;
        }
    ...
    public function setDayid($v)
    {
        ...
        if ($this->dayid !== $v) {
            $this->dayid = $v;
            $this->modifiedColumns[ReservationTableMap::COL_DAYID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ReservationTableMap::translateFieldName('Playerid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->playerid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ReservationTableMap::translateFieldName('Dayid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ReservationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Reservation'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ReservationTableMap::COL_PLAYERID)) {
            $modifiedColumns[':p' . $index++]  = 'playerid';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_DAYID)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Reservation The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReservationTableMap::COL_PLAYERID)) {
            $criteria->add(ReservationTableMap::COL_PLAYERID, $this->playerid);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_DAYID)) {
            $criteria->add(ReservationTableMap::COL_DAYID, $this->dayid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Reservation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Reservation Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGameday(ConnectionInterface $con = null)
    {
        if ($this->aGameday === null && ($this->dayid != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGameday->addReservations($this);
             */
        }
    ...
    public function getPlayer(ConnectionInterface $con = null)
    {
        if ($this->aPlayer === null && ($this->playerid != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPlayer->addReservations($this);
             */
        }
    ...
    {
        if (null !== $this->aGameday) {
            $this->aGameday->removeReservation($this);
        }
        if (null !== $this->aPlayer) {
            $this->aPlayer->removeReservation($this);
        }
        $this->id = null;
        $this->playerid = null;
        $this->dayid = null;

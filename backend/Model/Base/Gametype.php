...
/**
 * Base class that represents a row from the 'gametype' table.
 *
 *
 *
 * @package    propel.generator.Model.Base
 */
abstract class Gametype implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\GametypeTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Gametype object.
     */
    ...
    /**
     * Compares this with another <code>Gametype</code> instance.  If
     * <code>obj</code> is an instance of <code>Gametype</code>, delegates to
     * <code>equals(Gametype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Model\Gametype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[GametypeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[GametypeTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GametypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GametypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = GametypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Gametype'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGametypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Gametype::setDeleted()
     * @see Gametype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGametypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GametypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GametypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(GametypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO gametype (%s) VALUES (%s)',
    ...
    {
        $pos = GametypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Gametype'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Gametype'][$this->hashCode()] = true;
        $keys = GametypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Gametype The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(GametypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(GametypeTableMap::COL_ID)) {
            $criteria->add(GametypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(GametypeTableMap::COL_NAME)) {
            $criteria->add(GametypeTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildGametypeQuery::create();
        $criteria->add(GametypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Gametype (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Gametype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildGametype is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGametype The current object (for fluent API support)
     */
    public function setGamedayrulesets(Collection $gamedayrulesets, ConnectionInterface $con = null)
    {
        ...
        foreach ($gamedayrulesetsToDelete as $gamedayrulesetRemoved) {
            $gamedayrulesetRemoved->setGametype(null);
        }
    ...
    protected function doAddGamedayruleset(ChildGamedayruleset $gamedayruleset)
    {
        ...
        $gamedayruleset->setGametype($this);
    }
    ...
    public function removeGamedayruleset(ChildGamedayruleset $gamedayruleset)
    {
        if ($this->getGamedayrulesets()->contains($gamedayruleset)) {
            ...
            $gamedayruleset->setGametype(null);
        }
     ...
     * Otherwise if this Gametype is new, it will return
     * an empty collection; or if this Gametype has previously
     * been saved, it will retrieve related Gamedayrulesets from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Gametype.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(GametypeTableMap::DEFAULT_STRING_FORMAT);
    }

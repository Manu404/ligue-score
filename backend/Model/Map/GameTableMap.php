...
class GameTableMap extends TableMap
{
     ...
     */
    const COL_TYPE = 'game.type';

    /**
     * the column name for the dayid field
     */
    const COL_DAYID = 'game.dayid';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Type', 'Dayid', ),
        self::TYPE_CAMELNAME     => array('id', 'type', 'dayid', ),
        self::TYPE_COLNAME       => array(GameTableMap::COL_ID, GameTableMap::COL_TYPE, GameTableMap::COL_DAYID, ),
        self::TYPE_FIELDNAME     => array('id', 'type', 'dayid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Type' => 1, 'Dayid' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'type' => 1, 'dayid' => 2, ),
        self::TYPE_COLNAME       => array(GameTableMap::COL_ID => 0, GameTableMap::COL_TYPE => 1, GameTableMap::COL_DAYID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'type' => 1, 'dayid' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'game.id' => 'ID',
        'GameTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Type' => 'TYPE',
        'Game.Type' => 'TYPE',
        'type' => 'TYPE',
        'game.type' => 'TYPE',
        'GameTableMap::COL_TYPE' => 'TYPE',
        'COL_TYPE' => 'TYPE',
        'Dayid' => 'DAYID',
        'Game.Dayid' => 'DAYID',
        'dayid' => 'DAYID',
        'game.dayid' => 'DAYID',
        'GameTableMap::COL_DAYID' => 'DAYID',
        'COL_DAYID' => 'DAYID',
    ];
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Transactions', '\\Model\\Transactions', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':gameid',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GameTableMap::COL_TYPE);
            $criteria->addSelectColumn(GameTableMap::COL_DAYID);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(GameTableMap::COL_ID);
            $criteria->removeSelectColumn(GameTableMap::COL_TYPE);
            $criteria->removeSelectColumn(GameTableMap::COL_DAYID);
        } else {

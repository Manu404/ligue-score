...
class PlayerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.PlayerTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Player';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Player';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Mail', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'mail', ),
        self::TYPE_COLNAME       => array(PlayerTableMap::COL_ID, PlayerTableMap::COL_NAME, PlayerTableMap::COL_MAIL, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'mail', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Mail' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'mail' => 2, ),
        self::TYPE_COLNAME       => array(PlayerTableMap::COL_ID => 0, PlayerTableMap::COL_NAME => 1, PlayerTableMap::COL_MAIL => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'mail' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'player.id' => 'ID',
        'PlayerTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Player.Name' => 'NAME',
        'name' => 'NAME',
        'player.name' => 'NAME',
        'PlayerTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'Mail' => 'MAIL',
        'Player.Mail' => 'MAIL',
        'mail' => 'MAIL',
        'player.mail' => 'MAIL',
        'PlayerTableMap::COL_MAIL' => 'MAIL',
        'COL_MAIL' => 'MAIL',
    ];
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Player');
    ...
    {
        $this->addRelation('Gameplayers', '\\Model\\Gameplayers', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':playerid',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('TransactionsRelatedBySourceid', '\\Model\\Transactions', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':sourceid',
    1 => ':id',
  ),
), null, null, 'TransactionssRelatedBySourceid', false);
        $this->addRelation('TransactionsRelatedByTargetid', '\\Model\\Transactions', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':targetid',
    1 => ':id',
  ),
), null, null, 'TransactionssRelatedByTargetid', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PlayerTableMap::COL_MAIL);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(PlayerTableMap::COL_ID);
            $criteria->removeSelectColumn(PlayerTableMap::COL_NAME);
            $criteria->removeSelectColumn(PlayerTableMap::COL_MAIL);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Player) { // it's a model object

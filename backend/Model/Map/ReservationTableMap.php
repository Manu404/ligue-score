...
class ReservationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.ReservationTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Reservation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Reservation';
     ...
     */
    const COL_PLAYERID = 'reservation.playerid';

    /**
     * the column name for the dayid field
     */
    const COL_DAYID = 'reservation.dayid';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Playerid', 'Dayid', ),
        self::TYPE_CAMELNAME     => array('id', 'playerid', 'dayid', ),
        self::TYPE_COLNAME       => array(ReservationTableMap::COL_ID, ReservationTableMap::COL_PLAYERID, ReservationTableMap::COL_DAYID, ),
        self::TYPE_FIELDNAME     => array('id', 'playerid', 'dayid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Playerid' => 1, 'Dayid' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'playerid' => 1, 'dayid' => 2, ),
        self::TYPE_COLNAME       => array(ReservationTableMap::COL_ID => 0, ReservationTableMap::COL_PLAYERID => 1, ReservationTableMap::COL_DAYID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'playerid' => 1, 'dayid' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'playerid' => 'PLAYERID',
        'reservation.playerid' => 'PLAYERID',
        'ReservationTableMap::COL_PLAYERID' => 'PLAYERID',
        'COL_PLAYERID' => 'PLAYERID',
        'Dayid' => 'DAYID',
        'Reservation.Dayid' => 'DAYID',
        'dayid' => 'DAYID',
        'reservation.dayid' => 'DAYID',
        'ReservationTableMap::COL_DAYID' => 'DAYID',
        'COL_DAYID' => 'DAYID',
    ];
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReservationTableMap::COL_PLAYERID);
            $criteria->addSelectColumn(ReservationTableMap::COL_DAYID);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(ReservationTableMap::COL_PLAYERID);
            $criteria->removeSelectColumn(ReservationTableMap::COL_DAYID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Reservation) { // it's a model object
